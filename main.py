...
viz.visualizing_question_1(df_clean_question_1)
viz.visualizing_question_2_a(df_clean_question_2)
viz.visualizing_question_2_b(df_clean_question_2)
viz.visualizing_question_3(df_clean_question_2)